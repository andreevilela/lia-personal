        	...
        	<div class="panel panel-default">
            	<div class="panel-body">
              	<ul class="nav nav-tabs">
                	<li class="active"> <a>Excluir Refeição</a> </li>
              	</ul>
<br>
...
<?php
	...
	?>
        ...
        <form class="form-horizontal" role="form" method="post" action="excluidorefeicao.php">
        	<input type="hidden" name="id" id="id" value="<?php print"$id"; ?>" placeholder="">
        		<div class="form-group">
                        <div class="col-sm-4">
                            <input type="text" name="data" class="form-control" id="data" disabled value="<?php print"$refeicao"; ?>" placeholder="">
                        </div>
                </div>
<br>
                <div class="form-group"> 
