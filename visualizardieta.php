        	...
        	<div class="panel panel-default">
            	<div class="panel-body">
                	<ul class="nav nav-tabs">
                    	<li class="active"> <a>&nbsp;Dieta&nbsp;</a> </li>
                        <li class="cinzaEscuro"> <?php echo"<a href='alterardieta.php?id=$cod'>Alterar</a>";?> </li>
                        <li class="cinzaEscuro"> <?php echo"<a href='excluirdieta.php?id=$cod'>Excluir</a>";?> </li>
                    </ul>   
<?php
include "banco.php";
        ...
        <form class="form-horizontal" role="form" method="post" action="alteradodieta.php">
        	<input type="hidden" name="id" id="id" value="<?php print"$cod"; ?>" placeholder="">
                ...
                <div class="form-group"> 
                    ...
                    <?php echo"<a href='exportardieta.php?id=$cod'><button type='button' class='btn btn-default active'>Exportar</button></a>";?>
                    <a href="dieta.php"><button type="button" class="btn btn-default active">&nbsp;Voltar&nbsp;</button></a>
                    </div>
                </div>    
        </form>
        	</div>
