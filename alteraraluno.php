...
<main class="container-fluid">
	...
	?>
        ...
        <form class="form-horizontal" role="form" method="post" action="alteradoaluno.php">
        	<input type="hidden" name="id" id="id" value="<?php print"$id"; ?>" placeholder="">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2">Nome</label>
                        <div class="col-sm-10"> 
                            <input type="text" name="nome" class="form-control" id="nome" value="<?php print "$nome"; ?>" required placeholder="">
                        </div>
               		<label class="control-label col-sm-2"></label>
                        <div class="col-sm-10">
                        	<?php ?>
                    ...
                    <label class="control-label col-sm-2">Sexo</label>
                        <div class="col-sm-4">
                        	<?php if ($sexo == 'Masculino')
							 ...
							 ?>
                            <label class="radio-inline"><input type="radio" name="sexo" value="Masculino" <?php print "$masculino"; ?>>Masculino</label>
                            <label class="radio-inline"><input type="radio" name="sexo" value="Feminino" <?php print "$feminino"; ?>>Feminino</label>
                        </div>
                        
                    <label class="control-label col-sm-2">Data de Nascimento</label>
                        <div class="col-sm-4">
                            <input type="text" name="data_nascimento" class="form-control" id="data" value="<?php print "$data_nascimento"; ?>" placeholder="dd/mm/aaaa">
                        </div>
                    <label class="control-label col-sm-2"></label>
                        <div class="col-sm-4">
                        	<?php  ?>
                ...
                <div class="form-group">
                	<label class="control-label col-sm-2">Telefone</label>
                        <div class="col-sm-4">
                            <input type="text" name="telefone" class="form-control" id="telefone" value="<?php print "$telefone"; ?>" placeholder="0000-0000">
                        </div>
                    <label class="control-label col-sm-2">Celular</label>
                        <div class="col-sm-4">
                            <input type="text" name="celular" class="form-control" id="celular" value="<?php print "$celular"; ?>" placeholder="00000-0000">
                        </div>
                    <label class="control-label col-sm-2"></label>
                        <div class="col-sm-4">
